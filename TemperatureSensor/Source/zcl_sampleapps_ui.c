...
const uint8 batteryXBM[132] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x1F, 0x00, 0x80, 0x1F, 0x00, 0xF8, 0xFF, 0x01, 0xFC,
                               0xFF, 0x03, 0x0E, 0x00, 0x07, 0x06, 0x00, 0x06, 0xE6, 0x7F, 0x06, 0xE6, 0x7F, 0x06, 0xE6, 0x7F,
                               0x06, 0xE6, 0x7F, 0x06, 0x06, 0x00, 0x06, 0xE6, 0x7F, 0x06, 0xE6, 0x7F, 0x06, 0xE6, 0x7F, 0x06,
                               0xE6, 0x7F, 0x06, 0x06, 0x00, 0x06, 0xE6, 0x7F, 0x06, 0xE6, 0x7F, 0x06, 0xE6, 0x7F, 0x06, 0xE6,
                               0x7F, 0x06, 0x06, 0x00, 0x06, 0x0E, 0x00, 0x07, 0xFC, 0xFF, 0x03, 0xF8, 0xFF, 0x01, 0x00, 0x00, 
                               0x00};
const uint8 antenna_connected[108] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x03, 0x00, 0x00, 0xC0, 0x07,
                                      0x00, 0x00, 0xC0, 0x07, 0x00, 0x00, 0xC0, 0x07, 0x00, 0x00, 0xC0, 0x07, 0x00, 0x00, 0xC7, 0x07,
                                      0x00, 0x80, 0xCF, 0x07, 0x00, 0x80, 0xCF, 0x07, 0x00, 0x80, 0xCF, 0x07, 0x00, 0x80, 0xCF, 0x07,
                                      0x00, 0x80, 0xCF, 0x07, 0x00, 0x8E, 0xCF, 0x07, 0x00, 0x9F, 0xCF, 0x07, 0x00, 0x9F, 0xCF, 0x07,
                                      0x00, 0x9F, 0xCF, 0x07, 0x00, 0x9F, 0xCF, 0x07, 0x00, 0x9F, 0xCF, 0x07, 0x1C, 0x9F, 0xCF, 0x07,
                                      0x3E, 0x9F, 0xCF, 0x07, 0x3E, 0x9F, 0xCF, 0x07, 0x3E, 0x9F, 0xCF, 0x07, 0x3E, 0x9F, 0xCF, 0x07,
                                      0x3E, 0x9F, 0xCF, 0x07, 0x1C, 0x0E, 0x87, 0x03, 0x00, 0x00, 0x00, 0x00};

const uint8 antenna_not_connected[108] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x03, 0x00, 0x00, 0xC0, 0x07, 0x00, 0x00, 0xC0, 0x06, 0x00, 0x00, 0xC0, 0x06, 0x00, 0x00, 0xC0, 0x06, 0x00, 0x00, 0xC7, 0x06, 0x00, 0x80, 0xCF, 0x06, 0x63, 0x80,
  0xCD, 0x06, 0x77, 0x80, 0xCD, 0x06, 0x3E, 0x80, 0xCD, 0x06, 0x1C, 0x80, 0xCD, 0x06, 0x3E, 0x8E, 0xCD, 0x06, 0x77, 0x9F, 0xCD, 0x06, 0x63, 0x9B, 0xCD, 0x06, 0x00, 0x9B, 0xCD, 0x06, 0x00, 0x9B, 0xCD, 0x06, 0x00, 0x9B, 0xCD, 0x06, 0x1C, 0x9B,
  0xCD, 0x06, 0x3E, 0x9B, 0xCD, 0x06, 0x36, 0x9B, 0xCD, 0x06, 0x36, 0x9B, 0xCD, 0x06, 0x36, 0x9B, 0xCD, 0x06, 0x3E, 0x9F, 0xCF, 0x07, 0x1C, 0x0E, 0x87, 0x03, 0x00, 0x00, 0x00, 0x00};

void TempToStr(int16 i, char b[])
{
...
void PercentToStr(uint16 i, char b[])
{
  char const digit[] = "0123456789";
...
void UpdateEink(int16 temp, uint8 batt, devStates_t nwkState)
{
  char tempStr[5] = {0};
  char batStr[5] = {0};
  const uint8* antennaIcon;
  uint16 battPercent = (batt >= VDD_3_0) ? 100 : ((batt - VDD_MIN_RUN) * 100 / (VDD_3_0 - VDD_MIN_RUN));
  
  if (nwkState == DEV_END_DEVICE)
    antennaIcon = antenna_connected;
  else
    antennaIcon = antenna_not_connected;

  TempToStr(temp, tempStr);
  
  PercentToStr(battPercent, batStr);

  u8x8_gpio_SetReset(&u8g2.u8x8, 1);
  u8x8_gpio_Delay(&u8g2.u8x8, U8X8_MSG_DELAY_MILLI, u8g2.u8x8.display_info->reset_pulse_width_ms);
  u8x8_gpio_SetReset(&u8g2.u8x8, 0);
  u8x8_gpio_Delay(&u8g2.u8x8, U8X8_MSG_DELAY_MILLI, u8g2.u8x8.display_info->reset_pulse_width_ms);
  u8x8_gpio_SetReset(&u8g2.u8x8, 1);
  u8x8_gpio_Delay(&u8g2.u8x8, U8X8_MSG_DELAY_MILLI, u8g2.u8x8.display_info->post_reset_wait_ms);
  ...
  do
  {
    u8g2_DrawFrame(&u8g2, 0, 0, 200, 200);
    u8g2_DrawXBM(&u8g2, 3,3, 20, 32, batteryXBM);
    u8g2_DrawXBM(&u8g2, 169,3, 28, 27, antennaIcon);
    u8g2_SetFont(&u8g2, u8g2_font_logisoso62_tn);
    u8g2_DrawStr(&u8g2, 20, 130, tempStr);
    u8g2_SetFont(&u8g2, u8g2_font_logisoso22_tf);
    u8g2_DrawStr(&u8g2, 165, 80, "°C");
    u8g2_DrawStr(&u8g2, 20, 190, "temperature");
    u8g2_DrawStr(&u8g2, 23, 28, batStr);
  }
