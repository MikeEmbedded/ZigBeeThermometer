...
#define SAMPLETEMPERATURESENSOR_MAX_MEASURED_VALUE  0000  // 00.00C
#define SAMPLETEMPERATURESENSOR_MIN_MEASURED_VALUE  5000  // 50.00C
...
const uint8 zclSampleTemperatureSensor_PowerSource = POWER_SOURCE_BATTERY;
...
int16 zclSampleTemperatureSensor_MinMeasuredValue = SAMPLETEMPERATURESENSOR_MIN_MEASURED_VALUE; 
int16 zclSampleTemperatureSensor_MaxMeasuredValue = SAMPLETEMPERATURESENSOR_MAX_MEASURED_VALUE;
